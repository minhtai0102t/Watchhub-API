...
namespace Ecom_API.Migrations.ApiDbContextHostingMigrations
{
    ...
    [Migration("20230625061441_UpdateDb56")]
    partial class UpdateDb56
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Ecom_API.DTO.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime>("created_date")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2023, 6, 25, 6, 14, 41, 71, DateTimeKind.Utc).AddTicks(7820));
                    ...
                    b.Property<List<string>>("user_addresses")
                        .HasColumnType("text[]");
