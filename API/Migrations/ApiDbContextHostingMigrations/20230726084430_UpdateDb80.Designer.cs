...
namespace Ecom_API.Migrations.ApiDbContextHostingMigrations
{
    ...
    [Migration("20230726084430_UpdateDb80")]
    partial class UpdateDb80
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ecom_API.DTO.Entities.ProductFeedback", b =>
                {
                    ...
                    b.HasOne("Ecom_API.DTO.Entities.User", "User")
                        .WithMany("productFeedbacks")
            ...
            modelBuilder.Entity("Ecom_API.DTO.Entities.VNPay", b =>
                {
                    b.HasOne("Ecom_API.DTO.Entities.Order", "Order")
                        .WithOne("vnpay")
                        .HasForeignKey("Ecom_API.DTO.Entities.VNPay", "OrderID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
